...
pub struct adapter_claude_localAdapter;

impl adapter_claude_localAdapter {
    #[must_use]
    pub fn new() -> Self {
        Self
    }
...
impl Default for adapter_claude_localAdapter {
    fn default() -> Self {
        Self::new()
    }
}
...
#[async_trait]
impl Adapter for adapter_claude_localAdapter {
    fn descriptor(&self) -> AdapterDescriptor {
        AdapterDescriptor::builtin(ADAPTER_TYPE, "Claude Code")
    }
...
mod tests {
    ...
    fn descriptor_returns_correct_type() {
        let adapter = adapter_claude_localAdapter::new();
