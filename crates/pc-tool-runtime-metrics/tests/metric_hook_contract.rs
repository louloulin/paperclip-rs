...
use pc_tool_runtime_metrics::{MetricHook, MetricHookEvent, NoopMetricHook, RecordingMetricHook, ToolRuntimeMetrics};
use uuid::Uuid;
...
fn minute_bucket_helper_via_service() {
    ...
    let bucket = ToolRuntimeMetrics::minute_bucket(at);
