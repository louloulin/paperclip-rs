...
pub const RESERVED_SLUGS: &[&str] = &[
    ...
    "signup", "register", "billing", "support", "docs", "help",
    "issues", "agents", "runtimes", "skills", "plugins", "channels",
    "autopilots", "squads", "projects", "inbox", "inbox-archive",
    "workspaces", "members", "profile", "me",
];
