...
| **schema 一致率** | 表级 = 本仓建出的上游表 / 上游 head **114** 张；对象级 = 1 − drift 差异数 / 上游 2146 对象（口径与复算命令：`docs/25-W0-SCHEMA-DRIFT.md` §4/§8） | 表级 **22.8%**（26/114）；对象级 23.7%（508/2146） | 70% | 100% |
...
| M2-C（既有） | 已合并 | W2 |
| T1（路由对账脚本） | 在飞 | **W0 ④ 门禁** |
| W0-B（上游 schema 快照 + drift 对账，LUM-1386） | 本切片交付（PR 见 issue） | **W0 ③ 门禁** + P4/§6.3 机制（`docs/25-W0-SCHEMA-DRIFT.md`） |
