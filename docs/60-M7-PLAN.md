...
4. 子 issue（全部 `backlog`，`--parent LUM-1764`，stage 与 §4.1 一一对应）：见交付评论里的建单清单（22 个）。
...
## 11. M7-INT 落地记录（占位，由 M7-21 填写）

（待 M7 波次收口后由 `M7-21` 填写：⑦/⑨/⑩ 快照刷新读数、baseline 344→430 的实测、剩余缺口逐个登记、以及本波实际未落地的项。）
