...
- 命中: **0**
- UI 调用但 OpenAPI 缺失: **15**
- OpenAPI 声明但 UI 未用: **10**
- **覆盖率: 0.0%**
...
| GET | `/api/auth${path}` | api/auth.ts |
| GET | `/api/auth${path}` | api/auth.ts |
| GET | `/api/auth${path}` | api/auth.ts |
| GET | `/api/auth${path}` | api/auth.ts |
| GET | `/api/auth${path}` | api/auth.ts |
| GET | `/api/auth/get-session` | api/auth.ts |
| GET | `/api/auth/get-session` | api/auth.ts |
| GET | `/api/auth/profile` | api/auth.ts |
| GET | `/api/auth/profile` | api/auth.ts |
...
| GET | `/api/health/dev-server/restart` | api/health.ts |
| GET | `/api/health/dev-server/restart` | api/health.ts |
